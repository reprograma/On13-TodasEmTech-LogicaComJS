...
let name = "Sâmara Nascimento Albuquerque";
...
let primeiroContato = "já tive alguns contatos básicos com JavaScript";
...
console.log('Meu nome é '  + name + ' , nasci no ano de '+ year + ' e ' + primeiroContato)
