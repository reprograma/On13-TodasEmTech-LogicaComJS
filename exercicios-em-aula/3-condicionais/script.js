...
switch (numeroEscolhido){
  case 1:
  alert(`${numeroEscolhido} hoje é Segunda`);
  break;
  case 2:
  alert(`${numeroEscolhido} hoje é Terça`);
  break;
  case 3:
  alert(`${numeroEscolhido} hoje é Quarta`);
  break;
  case 4:
  alert(`${numeroEscolhido} hoje é Quinta`);
  break;
  case 5:
  alert(`${numeroEscolhido} hoje é Sexta`);
  break;
  case 6:
  alert(`${numeroEscolhido} hoje é Sábado`);
  break;
  case 7:
  alert(`${numeroEscolhido} hoje é Domingo`);
  break;
  default:
